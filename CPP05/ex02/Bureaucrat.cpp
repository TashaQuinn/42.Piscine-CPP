...
/*   Updated: 2022/10/30 07:57:31 by jbania           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char* Bureaucrat::GradeTooHighException::what() const throw() {
    ...
    return "Sweet gorilla of Manila, bureaucrat's grade is too high!";
	
}

const char* Bureaucrat::GradeTooLowException::what() const throw() {

    return "Sweet gorilla of Manila, bureaucrat's grade is too low!";
